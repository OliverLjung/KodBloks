...
class HelpWindow:
    ...
    def sve(self):
        ...
        self.not_finished_text = self.text_font.render('Något är inte slut än, t.ex spelet.', True, self.white,)
    ...
    def eng(self):
        ...
        self.not_finished_text = self.text_font.render('Something is not over yet, e.g the game.', True, self.white,)
        self.not_finished_rect = self.not_finished_text.get_rect()
